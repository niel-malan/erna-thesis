...
\qauthor{T-shirt slogan, popular with truckers, reflecting the entrenched role of petrodiesel in the heavy transport industry.}
\end{savequote}
...
\autocite{Knothe2005}, or for its ability to reduce engine emissions (see
Section \ref{sec:FuelFormulation}) \autocite{Wattrus2016}. In South Africa the
...
(see Section \ref{sec:IncompleteCombustion}). PAHs are also abundant in fossil
fuels, including diesel, and might escape from diesel during normal operations
or in leaks and spills. Primarily, however, the higher the proportion of
aromatic compounds in diesel fuel, the higher the PAH emissions of the engine it
fuels \autocite{deSouza2016}. These higher emissions are ascribed to the poorer
combustion of fuels containing higher amounts of aromatics. For all these
reasons regulators aim to reduce the exposure of the population to the harm of
PAHs by limiting the amount of PAHs in diesel.
...
\caption{Aromatic compounds added to a \SI{1.2819}{\gram} low-sulfur diesel sample}
	...
	\raisebox{-.5\height}{\rule{0pt}{13mm}}\raisebox{-.5\height}{\includegraphics{Figures/Aromatics/cumene.pdf}} & \text{cumene} & 153.\text{${}^{\circ}$C} & 8.4 \\
 	...
 	\hline
 	\raisebox{-.5\height}{\rule{0pt}{24mm}}\raisebox{-.5\height}{\includegraphics{Figures/Aromatics/benzo[a]pyrene.pdf}}& \text{benzo[\textit{a}]pyrene} & 495.\text{${}^{\circ}$C} & 3.1 \\
 	\hline
\end{tabular}
\end{table}
...
benzo[\textit{a}]pyrene shows that it elutes in \twoD without wrap-around. This
very long retention time of a very simple PAH compound means that perhaps the
method described in \std{ASTM 5186} cannot quantify PAHs with more than four
rings in diesel. This is no failure: ``PAHs with molecular weight greater than
pyrene (\SI{202 }{\gram\per\mole}) are not usually found in diesel or have low
concentrations'', \autocite{deSouza2016} and require methods with very low
...
Being able to determine the biodiesel content of diesel blends may prove
