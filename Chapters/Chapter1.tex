...
produce a flow of waste. This waste is an \keyword{aerosol}:
...
it is an reasonable response to pollution. If pollutants enter the biosphere at
...
earth's surface out to space, both of which must pass through the atmosphere. A
...
absorbs near ultraviolet and visible light, which makes it also similar to the
...
of kinetic energy, and this kinetic energy is randomly distributed among
the gases of the atmosphere, appearing as an increase in temperature as the
...
temperatures in the atmosphere. It has also become increasingly certain that
this increase in temperature is inevitable and significant: it will change the
...
therefore also diluted in the oceans. This leads to \keyword{ocean
acidification}, a gigaton problem in its own right, but one that falls outside
...
way to generate that information is a discipline called \keyword{life cycle
analysis} (LCA). Life cycle analysis can yield rigorously-calculated data and
...
Highveld, in coal-fired power stations which emits carbon dioxide in the
...
chemical reactions induced by sunlight produces \keyword{ozone}, a reactive
...
octane booster. The emitted lead compounds was shown to be a pollutant that
leads to neurological impairment in its victims, and its use was phased out
...
collectively called \nox. These oxides can participate in the cycle that causes
a from of pollution called \keyword{photochemical smog}. They will also dissolve
in atmospheric water and form acids: this might happen far from the point of
...
per cent, whereas the efficiency of a mass-produced silicon-based solar
\keyword{photovoltaic} (PV) panel is in excess of \SI{20}{\percent}. In general,
if mechanical power is required it will be much more efficient to capture solar
energy in a PV panel and use it to power an electric motor than to produce a
biofuel and use it to fuel an internal-combustion engine.
...
sterile environment to prevent contamination by other micro-organism.
...
\keyword{transesterification} of the oil was implemented, replacing the glycerol
