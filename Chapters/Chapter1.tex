...
A rational, discerning society in searching for ways to carbon dioxide emissions
...
\keyword{efficiency}. Efficiency of an engine is calculated by taking the ratio
...
processes involved using at \keyword{pV} diagram, showing the changes of state of
...
\keyword{knocking}, when the homogenous air/fuel mixture detonates instead of
burning smoothly. The shock waves from this detonation will damage the engine
and lead to faster wear. (The \keyword{octane number} of a fuel indicates the
...
far from the point of emission, resulting in \keyword{acid rain}. 
