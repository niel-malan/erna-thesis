...
\chapter[Fast GC]{Fast temperature programmed gas chromatography} % Main chapter title
...
A FLIR{\texttrademark} T660 thermal imaging camera was used to obtain a video of
...
\keyword{tuning}, and usually consists of determining the optimum values of a
