...
Standards are published by \keyword{standards organizations}, which might
...
requirements of SANS 1935 is lower than the solubility of water in biodiesel,
and therefore refers to dissolved water. Free, visible water is excluded by
paragraph 4.1.4.
...
certain wavelengths and measuring the amount of light absorbed will give an
indication of the amount. Alternatively, EN 14538 may be used to determine
sodium and potassium simultaneously with calcium and magnesium (see Section
...
must be determined by a procedure compliant with SANS 54105 (or, equivalently,
EN 14105). In this method, the biodiesel sample is treated with MSTFA
(2,2,2-Tri\-fluoro-N-methyl-N-(trimethylsilyl)acetamide) before separation by
GC. MSTFA is a \keyword{derivatization reagent}: It reacts with the hydroxyl
groups in the glycerides to form trimethylsilyl derivatives, as shown in Figure
...
54106 method is a \keyword{porous layer open tubular} (PLOT) column,
...
Africa and SANS 342 sets the standard for petrodiesel. As can be expected, there
is considerable overlap of the requirements of petrodiesel and biodiesel,
summarized in Figure \ref{fig:Venn}.
...
\subsubsection[FAMEs by IR]{Determining FAMES in blends by IR}
