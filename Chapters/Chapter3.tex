...
usually referred to as \std{ISO 9001}. To distinguish between standards bodies
and their documents, in this thesis the numbers of technical standards will be
rendered in \textsc{small caps}, \textit{e.g.} \std{SANS 1935}.
...
\keyword{property}, the second column specifies a \keyword{requirement}, a
numerical value the property has to conform to, and the third column prescribes
...
filled tube, and therefore on the density of the liquid. These devices are easy
to use and very accurate. The temperature of the liquid is controlled
electronically.
...
If the FAME composition of the biodiesel is known, its density can be calculated
\autocite{Knothe2014}. Therefore a knowledge of biodiesel feedstock chemistry
can help guide the blending of biodiesel to produce a product that comply with
this requirement.
...
The viscosity of biodiesel is mainly determined by FAMEs it is composed of, and
it is possible to predict the viscosity if the chemical composition is known
\autocite{ChavarriaHernandez2014}. Therefore, if the feedstocks used in a
biodiesel blend have been chemically characterized, the knowledge can be used to
guide blending to achieve a compliant biodiesel.
...
the standard. But conversely, if the FAME composition of biodiesel is known, the
cetane number can be predicted \autocite{Tong2010}. This means that a knowledge
of the chemical composition of the biodiesel feedstock can help the biodiesel
producer to manufacture a compliant product.
...
\std{ISO 12966} recommends a very long\SI{100}{\percent} biscyanopropyl
...
The stationary phase of the column prescribed by \std{SANS 54105} is the
...
\keyword{porous layer open tubular} (PLOT) column (\SI{10}{\metre} x
...
the GC method in \std{ISO 12966} resolves all FAMEs isomers, including methyl
