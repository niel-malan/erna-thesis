...
\section{\std{SANS 1935}: An overview}
...
\section{\std{SANS 1935}: Properties, requirements and methods.}
...
\section{\std{SANS 1935}: Physical properties}
...
in\-stru\-mentation]{\std{SANS 1935}: Aggregate properties: \\ Specialized
in\-stru\-mentation}
...
specifically for FAME. \std{ISO 2719} specifies the use of a Pensky-Martin
...
The temperature at which the vapour ignites is the flash point. \std{ISO 3679}'s
...
\section{\std{SANS 1935}: Chemical properties: Classical determination}
...
\section{\std{SANS 1935}: Chemical properties: Electrochemical determination}
...
\section{\std{SANS 1935}: Chemical properties: Spectroscopic determination}
...
\section{\std{SANS 1935}: Chemical properties: Chromatographic determination}
\label{sec:ChromDet}
...
\section{Comparison of \std{SANS 1935} and \std{SANS 342}}
...
1935} for biodiesel and \std{SANS 342} for petrodiesel.}
