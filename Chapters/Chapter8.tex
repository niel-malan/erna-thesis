...
\keyword{linear power supply}. In practice terms this means that the excess
...
measurement}. In such a design the potential difference is measure using a
...
control} (PWM), then the actual cooling power can be controlled, and with it the
...
instruments can benefit from the use of \keyword{real-time operating systems.}
