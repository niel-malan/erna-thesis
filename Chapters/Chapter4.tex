...
than the HPLC pump. It takes up less space and does not need refilling, since
...
filled with a syringe, and when the valve is commanded to inject the sampling
