...
the \keyword{fatty acid profile}.
...
The modulation period was 10 seconds, and the fractions of the SFC eluate were
transferred to the GC inlet via a linear restrictor and collected on the cold
column. 
...
(petrodiesel). The volatility of biodiesel is slightly higher than that of
...
retained. As we've seen in the previous section, FAMEs are retained and
separated under such conditions. When we inject a blend of biodiesel and
petrodiesel on SFC×GC, we therefore expect the biodiesel portion to be
...
petrodiesel in the laboratory. The biodiesel had been produced from waste
cooking oil by an anonymous producer, and was donated by a commercial testing
laboratory, and the petrodiesel (Shell Extra Diesel 500 ppm) was obtained from a
consumer filling station. 

The injection system described in Section \ref{sec:SFCInjection} was used to
inject a \SI{0.5}{\micro\litre} volume of undiluted this B50 blend.

\subsection{SFC}

The SFC used unmodified carbon dioxide at \SI{200}{\bar} inlet pressure as
mobile phase. The column was five HPLC columns (150 mm $\times$ 4.6 mm, 3 $\mu$m
particles) (Restek, Pinnacle DB Silica) connected in series.
...
The capability can find application in quality control of blends and in tax
enforcement.\todo{Expand tax explanation.}
