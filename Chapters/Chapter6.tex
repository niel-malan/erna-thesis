...
double bond, which should make it oxidatively stable (see Section \ref{sec:Rancimat}), and
...
\ref{sec:Rancimat}), but the high melting point of the saturated FAMEs also
