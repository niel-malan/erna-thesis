...
compliant with SANS 1935: the mass fraction of fatty acid methyl esters with
four or more double bonds is more than \SI{1}{\percent}, which is above the
specified limit. 
...
In the example of FAMEs derived from various oils the pattern shows
