...
The devil is, of course, in the details. For example, mercury that find its way
...
(Of course I am not arguing that Victorian engineers designed steam engines
...
where \(\alpha \) is the \textit{cut-off ratio}. 
