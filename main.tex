...
This is a unique role, and she was uniquely qualified to fill it. My
conversations with her kept me rooted in reality.
...
who supplied us with an excellent used intrument at a nominal cost. Restek
supplied columns at no cost. Reynard Heymans from FLIR recorded thermal videos
of the coaxial heater in action without asking. Neil Frame from D.C. Wort who
supplied me with free material and offered valuable advice.
...
Virgin Active Health Clubs who kept the gym going.
...
This thesis is therefore with the following audience in mind:
...
\textbf{CCGT} & \textbf{C}ombined \textbf{c}ycle \textbf{g}as \textbf{t}urbine \\ 
\textbf{SFC×GC} & \textbf{C}ombined \textbf{c}ycle \textbf{g}as \textbf{t}urbine \\ 
\textbf{GC×GC} & \textbf{C}ombined \textbf{c}ycle \textbf{g}as \textbf{t}urbine \\ 
