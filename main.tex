...
\thesistitle{Analysis of biodiesel by \texorpdfstring{SFC$\times$GC}{SFC×GC}} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\item MY office mates, in no particular order: Sifiso Nsibande, Madelien Wooding, Kedibone Mashala, Portia
Makhubela, Chiedza Munyeza, Amanda \ldots, Margaux Lim-a-Tock,  
\end{itemize}
