...
separation is subjected to a second separation. The great difference between the
separation mechanisms of supercritical fluid chromatography (SFC) and gas
chromatography (GC) creates a very useful coupling, which is is technically
simple. To make the coupling practical the GC separation must be fast and
